            ...
            <div class="card border-0 shadow-lg my-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-lg" placeholder="Name" name="sku">
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label h4">Price</label>
                        <input type="text" class="form-control form-control-lg" placeholder="Name" name="price">
                    </div>
                    <div class="mb-3">
